...
| :--- |:--------| :--- | :--- |
| **`rss-state-store`** | `1.2.0` | [![npm](https://img.shields.io/badge/npm-@rssbr/state--store-cb3837?style=flat-square&logo=npm)](https://www.npmjs.com/package/@rssbr/state-store) | Reactive state management with automatic persistence, compatible with Angular 13+. |
